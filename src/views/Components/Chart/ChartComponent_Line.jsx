...
const ChartComponent_Line = ({
    ...
    const toolTipFormatFunction = (
        ...
        return `交卷時間:${dataSource[itemIndex]["交卷時間"]}<br>卷次:${dataSource[itemIndex]["卷次"]}<br>分數:${dataSource[itemIndex]["分數"]}`;
    };
...
export default ChartComponent_Line;
